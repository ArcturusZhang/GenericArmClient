...
{
    internal partial class AzureServiceClientDeleteAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of AzureServiceClientDeleteAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AzureServiceClient client used to send requests. </param>
        /// <param name="requestPath"></param>
        /// <param name="apiVersion"></param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AzureServiceClientDeleteAsyncCollectionResult(AzureServiceClient client, string requestPath, string apiVersion, PageableOptions options, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AzureServiceClientDeleteAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AzureServiceClientDeleteAsyncCollectionResult as an enumerable collection. </returns>
