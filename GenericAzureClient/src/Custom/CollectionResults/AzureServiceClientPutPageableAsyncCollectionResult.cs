...
{
    internal partial class AzureServiceClientPutPageableAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of AzureServiceClientPutPageableAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of AzureServiceClientPutPageableAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AzureServiceClientPutPageableAsyncCollectionResult as an enumerable collection. </returns>
